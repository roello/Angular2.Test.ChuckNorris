...
var FactsModule = (function () {
    function FactsModule() {
    }
    FactsModule = __decorate([
        core_1.NgModule({
            imports: [platform_browser_1.BrowserModule, http_1.HttpModule],
            declarations: [facts_list_component_1.FactsListComponent],
            bootstrap: [facts_list_component_1.FactsListComponent],
...
exports.FactsModule = FactsModule;
